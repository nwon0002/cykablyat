...
public interface SWEntityInterface extends EntityInterface {
	...
	/** NEW PART
     * Add Capability to <code>SWEntity</code> or <code>SWActor</code> .
     *
     * @param c the <code>Capability</code> to add
     * @see 	starwars.Capability
     * */
	public void addCapability(Capability c);

    /** NEW PART
     * Removes <code>Capability</code> of <code>SWEntity</code> or <code>SWActor</code> .
     *
     * @param c the <code>Capability</code> to remove
     * @see 	starwars.Capability
     * */
