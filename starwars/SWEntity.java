...
public class SWEntity extends Entity implements SWEntityInterface {
	...
	public HashSet<Capability> capabilities = new HashSet<Capability>();
	...
	//public HashSet<Capability> getCapabilities(){  return this.capabilities; }
    ...
    @Override
    public void addCapability(Capability c) { this.capabilities.add(c); }

	@Override
	public void removeCapability(Capability c) { this.capabilities.remove(c); }
